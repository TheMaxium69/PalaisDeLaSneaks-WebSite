  ...
  <main id="rachat">
    ...
    <div class="text">
      <h2>Vous souhaitez revendre votre paire ?</h2>
        ...
        <button class="custom-btn btn-2 uppercase btnVendre" onclick="window.location.href = 'https://www.instagram.com/direct/t/17845902335803781'">Je veux revendre ma paire</button>
      </div>
  <?php socialLink($page); ?>
